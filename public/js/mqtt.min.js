                        ...
                        (function () {
                            ...
                            function k(e, t) {
                                ...
                                if (0 === n.length) {
                                    if (void 0 === r)
                                        return new Error(
                                            "Unregistered Topic Alias"
                                        );
                                    if (
                                        void 0 ===
                                        (n =
                                            e.topicAliasSend.getTopicByAlias(r))
                                    )
                                        return new Error(
                                            "Unregistered Topic Alias"
                                        );
                                ...
                                y("MqttClient :: options.protocol", t.protocol),
                                    ...
                                    (this.messageIdProvider =
                                        ...
                                        this.options.messageIdProvider
                                            ...
                                            : this.options.messageIdProvider),
                                    (this.outgoingStore =
                                        t.outgoingStore || new o()),
                                    (this.incomingStore =
                                        t.incomingStore || new o()),
                                    (this.queueQoSZero =
                                        void 0 === t.queueQoSZero ||
                                        t.queueQoSZero),
                            ...
                            h(T, i),
                                (T.prototype._setupStream = function () {
                                    const e = this,
                                        t = new c(),
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            "object" ==
                                                typeof this.options.authPacket
                                        ) {
                                            S(
                                                this,
                                                g(
                                ...
                                (T.prototype._checkDisconnecting = function (
                                    e
                                ) {
                                    return (
                                        this.disconnecting &&
                                ...
                                (T.prototype.publish = function (e, t, r, n) {
                                    ...
                                    return (
                                        (this._storeProcessing ||
                                            this._storeProcessingQueue.length >
                                                0 ||
                                            !s()) &&
                                ...
                                (T.prototype.subscribe = function () {
                                    ...
                                    if (null !== l)
                                        return (
                                            m(
                                                o,
                                                new Error("Invalid topic " + l)
                                            ),
                                            this
                                        );
                                    if (this._checkDisconnecting(o))
                                        return (
                                            y("subscribe: discconecting true"),
                                            this
                                        );
                                    const u = { qos: 0 };
                                    if (
                                                        ...
                                                        b(
                                                            function () {
                                                                y(
                                                                    ...
                                                                    (n.disconnected =
                                                                        !0),
                                                                    n.incomingStore.close(
                                                                        function (
                                                                            e
                                                                        ) {
                                                                            n.outgoingStore.close(
                                                                                function (
                                                                                    t
                                                                                ) {
                                                                                    if (
                                ...
                                (T.prototype.removeOutgoingMessage = function (
                                    e
                                ) {
                                ...
                                (T.prototype._reconnect = function () {
                                    y(
                                        ...
                                        this.connected
                                            ...
                                            : (y(
                                                  "_reconnect: calling _setupStream"
                                              ),
                                              this._setupStream());
                                }),
                                        ...
                                        if (!this.connected)
                                            return "auth" === e.cmd
                                                ...
                                                : (y(
                                                  ...
                                                  void this._storePacket(
                                                      e,
                                                      t,
                                                      r
                                                  ));
                                        switch (
                                            (this._shiftPingInterval(), e.cmd)
                                        ) {
                                            case "publish":
                                                break;
                                            case "pubrel":
                                    ...
                                    if (5 === this.options.protocolVersion) {
                                        ...
                                        if (
                                            ...
                                            if (0 === r.length) {
                                                ...
                                                {
                                                    const e =
                                                        this.topicAliasRecv.getTopicByAlias(
                                                            t
                                                        );
                                                    if (!e)
                                                        return (
                                        ...
                                        switch (
                                            ...
                                            case "puback": {
                                                ...
                                                r &&
                                                    ...
                                                    this.messageIdProvider.deallocate(
                                                        t
                                                    ),
                                    ...
                                    if (
                                        ...
                                        if (this.options.resubscribe)
                                            if (
                                                ...
                                                y(
                                                    "_resubscribe: protocolVersion 5"
                                                );
                                                for (
                                                    let t = 0;
                                                    t < e.length;
                                                ...
                                                (this._resubscribeTopics.resubscribe =
                                                    !0),
                                                    this.subscribe(
                                                        this._resubscribeTopics
                                                    );
                                ...
                                (T.prototype._invokeStoreProcessingQueue =
                                    function () {
                                        if (
                                            this._storeProcessingQueue.length >
                                            0
                                ...
                                (T.prototype._invokeAllStoreProcessingQueue =
                                    function () {
                                        for (
                                            ;
                                            this._invokeStoreProcessingQueue();
                                ...
                                (T.prototype._flushStoreProcessingQueue =
                                    function () {
                                        for (const e of this
            ...
            2: [
                function (e, t, r) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        return (
                            (s = t.my).connectSocket({ url: c, protocols: r }),
                            (a = (function () {
                                const e = new i();
                                return (
            ...
            6: [
                function (e, t, r) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        (s = wx.connectSocket({ url: u, protocols: [r] })),
                            (a = (function () {
                                const e = new i();
                                return (
                                    (e._write = function (e, t, r) {
                ...
                function (e, t, r) {
                    (function (r) {
                        (function () {
                            ...
                            function u(e, t) {
                                if (
                                    (a("connecting to an MQTT broker..."),
                                    "object" != typeof e ||
                                        t ||
                                        ((t = e), (e = null)),
                                    (t = t || {}),
                                ...
                                const r = new n(function (e) {
                                    return (
                                        t.servers &&
                                            ...
                                            (t.protocol = t.servers[
                                                e._reconnectCount
                                            ].protocol
                                                ? t.servers[e._reconnectCount]
                                                      .protocol
                                                : t.defaultProtocol),
                                            (t.hostname = t.host),
                                            e._reconnectCount++),
                    ...
                    (o._init = function (e) {
                        ...
                        (o.prototype.copy = function (e, t, r, i) {
                            ...
                            if (l <= this._bufs[s[0]].length - c)
                                return o
                                    ? this._bufs[s[0]].copy(e, t, c, c + l)
                                    : this._bufs[s[0]].slice(c, c + l);
                            o || (e = n.allocUnsafe(a));
                            for (let t = s[0]; t < this._bufs.length; t++) {
                                const r = this._bufs[t].length - c;
                                if (!(l > r)) {
                                    this._bufs[t].copy(e, u, c, c + l),
                                        (u += r);
                                    break;
                                }
                                this._bufs[t].copy(e, u, c),
                                    (u += r),
                                    (l -= r),
                                    c && (c = 0);
                            }
                        ...
                        (o.prototype.consume = function (e) {
                            if (
                                ((e = Math.trunc(e)), Number.isNaN(e) || e <= 0)
                            )
                                return this;
                    ...
                    (function (t) {
                        (function () {
                            ...
                            (s.prototype.slice = function (e, t) {
                                ...
                                (s.prototype.writeUInt16LE = function (
                                    e,
                                    t,
                                    r
                                ) {
                                ...
                                (s.prototype.writeUInt16BE = function (
                                    e,
                                    t,
                                    r
                                ) {
                                ...
                                (s.prototype.writeUInt32BE = function (
                                    e,
                                    t,
                                    r
                                ) {
                                ...
                                (s.prototype.writeIntLE = function (
                                    e,
                                    t,
                                    r,
                                    n
                                ...
                                (s.prototype.writeDoubleLE = function (
                                    e,
                                    t,
                                    r
                                ) {
                                ...
                                (s.prototype.writeDoubleBE = function (
                                    e,
                                    t,
                                    r
                                ) {
                        ...
                        return (
                            ...
                            (r.enable = function (e) {
                                ...
                                r.save(e),
                                    ...
                                    (r.names = []),
                                    (r.skips = []);
                                const n = ("string" == typeof e ? e : "").split(
                                        /[\s,]+/
                                    ),
                                    i = n.length;
                                for (t = 0; t < i; t++)
                        ...
                        (this.pushBack = function (e) {
                            ...
                            (function () {
                                ...
                                e.size
                                    ...
                                    : e.length && (n = e.length);
                                var s = n * i.sigma;
                                (u = Math.ceil(s / i.bucketSize)),
                                    (u = Math.max(u, 3));
                                for (var l = 0; l < u; ++l)
                                    r.push(new Array(i.bucketSize));
                                var c = Math.ceil(n / i.bucketSize);
                                (o = Math.floor(u / 2) - Math.floor(c / 2)),
                                    (a = o),
                            ...
                            if (null !== t && void 0 !== t) {
                                ...
                                if (c[f]) {
                                    ...
                                    if (c[f] instanceof o.default) {
                                        ...
                                        c[f].pushBack({ key: e, value: t }),
                                            c[f].size() >= a.treeifyThreshold &&
                                                (c[f] = new s.default(c[f]));
                            ...
                            (this.eraseElementByKey = function (e) {
                                ...
                                if (c[l]) {
                                    ...
                                    if (c[l] instanceof s.default)
                                        c[l].eraseElementByKey(e),
                                            c[l].size() <=
                                                a.untreeifyThreshold &&
                                                (c[l] = new o.default(c[l]));
                                    else {
                                        var p = -1;
                                        try {
                                            for (
                                                var d = i(c[l]), g = d.next();
                                                !g.done;
                                                g = d.next()
                                            ) {
                                                if ((++p, g.value.key === e)) {
                    ...
                    function o(e) {
                        ...
                        (this.size = function () {
                            ...
                            (this.insert = function (e, t, n) {
                                ...
                                if (n < 0)
                                    throw new Error(
                                        "insert size must more than 0"
                                    );
                                if (0 === e) for (; n--; ) this.pushFront(t);
                                else if (e === r)
                                    for (; n--; ) this.pushBack(t);
                                else {
                ...
                function (e, t, r) {
                    ...
                    function s(e, t) {
                        ...
                        var d = function (e) {
                                ...
                                if (
                                    e.color !== o.default.TreeNodeColorType.red
                                ) {
                                    var r = e.brother;
                                    if (!r) throw new Error("unknown error");
                                    if (e === t.leftChild) {
                                    ...
                                    e.color = o.default.TreeNodeColorType.black;
                            },
                            g = function (e) {
                            ...
                            return n(this, function (t) {
                                switch (t.label) {
                                    ...
                                    case 1:
                                        return (
                                            t.sent(),
                                            [4, { key: e.key, value: e.value }]
                                        );
                                    case 2:
                                        return (
                                            t.sent(), [5, i(w(e.rightChild))]
                                        );
                                    case 3:
                                        return t.sent(), [2];
                                }
                    ...
                    t.exports = class {
                        ...
                        reset() {
                            this[u] &&
                                this[h] &&
                                this[h].length &&
                                this[h].forEach((e) => this[u](e.key, e.value)),
                                (this[f] = new Map()),
                                (this[h] = new n()),
                                (this[o] = 0);
                        }
                        ...
                        set(e, t, r) {
                            ...
                            if (this[f].has(e)) {
                                ...
                                return (
                                    this[u] && (this[c] || this[u](e, s.value)),
                                    (s.now = n),
                                    (s.maxAge = r),
                                    (s.value = t),
                                    (this[o] += a - s.length),
                ...
                function (e, t, r) {
                    ...
                    class l extends i {
                        ...
                        _parseSubscribe() {
                            ...
                            if (
                                ((e.subscriptions = []), this._parseMessageId())
                            ) {
                                if (5 === this.settings.protocolVersion) {
                                    const t = this._parseProperties();
                                    Object.getOwnPropertyNames(t).length &&
                            ...
                            for (; this._pos < t; ) {
                                ...
                                if (!e)
                                    return (
                                        this._emitError(
                                            new Error(
                                                "Cannot parse property code type"
                                            )
                                        ),
                                        !1
                                    );
                    ...
                    (function (r) {
                        (function () {
                                ...
                                switch (
                                                ...
                                                (k |=
                                                    l && l.qos
                                                        ? l.qos <<
                                                          n.WILL_QOS_SHIFT
                                                        : 0),
                                                (k |= l ? n.WILL_FLAG_MASK : 0),
                                                (k |= u
                                                    ? n.CLEAN_SESSION_MASK
                                                    : 0),
                                                t.write(r.from([k])),
                                                d(t, c),
                                                5 === a && b.write();
                                    ...
                                    case "pubcomp":
                                        return (function (e, t, i) {
                                            ...
                                            t.write(n.ACKS[a][c][u][0]),
                                                v(t, p),
                                                d(t, l),
                                                5 === o && t.write(r.from([h]));
                                            null !== g && g.write();
                                            return !0;
                                        })(e, t, s);
                                    case "subscribe":
                                        return (function (e, t, i) {
                                            ...
                                            for (const e of c) {
                                                ...
                                                w(t, i),
                                                    (c =
                                                        n.SUBSCRIBE_OPTIONS_QOS[
                                                            s
                                                        ]),
                                                    5 === o &&
                                                        ((c |= a
                                                            ? n.SUBSCRIBE_OPTIONS_NL
                                                            : 0),
                                                        (c |= l
                            ...
                            function v(e, t) {
                                if (t > n.VARBYTEINT_MAX)
                                    return (
                                        e.emit(
                                            "error",
                                            new Error(
                                                `Invalid variable byte integer: ${t}`
                                            )
                                        ),
                                        !1
                                    );
                                let r = m[t];
                                return (
                                    r || ((r = f(t)), t < 16384 && (m[t] = r)),
                                    l(
                                        "writeVarByteInt: writing to stream: %o",
                                        r
                                    ),
                                    e.write(r)
                                );
                            ...
                            function S(e, t) {
                                const r = c(t);
                                return (
                                    l("writeNumberGenerated: %o", r), e.write(r)
                                );
                            }
                            function E(e, t) {
                                "string" == typeof t
                            ...
                            !(function (n) {
                                ...
                                function R(e) {
                                    ...
                                    for (
                                        ...
                                        (m = e[s]) < 128 && T.push(E(m));
                                    for (
                                        n = i = T.length, i && T.push(b);
                                        n < v;
                ...
                function (e, t, r) {
                    (function (r) {
                        (function () {
                            ...
                            e("inherits")(u, i);
                            for (
                                var s = n(o.prototype), a = 0;
                                a < s.length;
                                a++
                            ) {
                                var l = s[a];
                                u.prototype[l] ||
                                    (u.prototype[l] = o.prototype[l]);
                            }
                            function u(e) {
                ...
                function (e, t, r) {
                    (function (r, n) {
                        (function () {
                            ...
                            function B(e, t) {
                                t.readingMore ||
                                    ((t.readingMore = !0), r.nextTick(R, e, t));
                            }
                            function R(e, t) {
                                for (
                                    ;
                            ...
                            (C.prototype.read = function (e) {
                                ...
                                (C.prototype.removeListener = function (e, t) {
                                    var n = s.prototype.removeListener.call(
                                        this,
                                        e,
                                        t
                                    );
                                    return (
                                        "readable" === e && r.nextTick(M, this),
                                        n
                                    );
                                }),
                                (C.prototype.removeAllListeners = function (e) {
                                    var t =
                                        s.prototype.removeAllListeners.apply(
                                            this,
                                            arguments
                                        );
                                    return (
                                ...
                                "function" == typeof Symbol &&
                                    (C.prototype[Symbol.asyncIterator] =
                                        function () {
                                            return (
                                                void 0 === f &&
                                                    (f = e(
                                ...
                                undestroy: function () {
                                    this._readableState &&
                                        ...
                                        this._writableState &&
                                            ...
                                            (this._writableState.finalCalled =
                                                !1),
                                            (this._writableState.prefinished =
                                                !1),
            ...
            76: [
                function (e, t, r) {
                    ...
                    (o.prototype.parse = function (e, t, r) {
                        ...
                        var V = v.indexOf("#");
                        -1 !== V &&
                            ((this.hash = v.substr(V)), (v = v.slice(0, V)));
                        var H = v.indexOf("?");
                        if (
                            (-1 !== H
