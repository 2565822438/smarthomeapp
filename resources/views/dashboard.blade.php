            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                    <div class="home">
                        ...
                        <input id="LED" type="checkbox" class="switch_1">
                    </div>
                </div>
                <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                    <div class="home">
...
<script>
    //事件监听
    document.getElementById("LED").addEventListener("click", displayDate1);
    document.getElementById("RELAY").addEventListener("click", displayDate2);
    //发送消息
    function displayDate1() {
        if (document.getElementById("LED").checked) {
            client.publish('qing', "{ \"text1\":\"LED\",\"text2\":'0'}"); //开灯
        } else {
            client.publish('qing', "{ \"text1\":\"LED\",\"text2\":'1'}"); //关灯
        }
    }
    function displayDate2() {
        if (document.getElementById("RELAY").checked) {
            client.publish('qing', "{ \"text1\":\"RELAY\",\"text2\":'0'}"); //开插座
        } else {
            client.publish('qing', "{ \"text1\":\"RELAY\",\"text2\":'1'}"); //插座
        }
    }
